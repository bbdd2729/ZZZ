...
namespace FairyGUI
{
    ...
    public class UIPackage
    {
...
#if UNITY_EDITOR
        static LoadResource _loadFromAssetsPath = (string name, string extension, Type type, out DestroyMethod destroyMethod) =>
        {
        ...
        static LoadResource _loadFromResourcesPath = (string name, string extension, Type type, out DestroyMethod destroyMethod) =>
        {
            destroyMethod = DestroyMethod.Unload;
        ...
        GObject CreateObject(PackageItem item, Type userClass)
        {
