    ...
    public partial class Bookmarks : EditorWindow
    {
        ...
        public static void Add(Object target) 
        {
            ...
            else
            {
                ...
                BookmarkReferences.Add(item);
                BookmarkReferences.Sort(new ProjectBookmarkComparer());
                cachedLabels = null;
                _folders = null;
                Save();
            }
        ...
        private void DrawProjectItems()
        {
            ...
            if (gridSize > minGridSize) DrawGridItems(BookmarkReferences.items);
            else DrawTreeItems(ref projectItemsList, BookmarkReferences.items);
        }
        ...
        private static void Remove(BookmarkItem item)
        {
            ...
            if (!item.target)
            {
                if (item.isProjectItem) BookmarkReferences.Remove(item as ProjectBookmark);
                else
                {
