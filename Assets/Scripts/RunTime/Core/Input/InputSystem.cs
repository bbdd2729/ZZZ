...
public class InputSystem : SingletonBase<InputSystem>, IInputSystem
{
    ...
    {
        get => InputActions.Player.Move.ReadValue<Vector2>(); //获取移动方向   只读属性
    }

    public Vector2 CameraLook
    {
        get => InputActions.Player.Look.ReadValue<Vector2>(); //获取相机方向   只读属性
    }
    ...
    public bool Space
    {
        get => InputActions.Player.Space.triggered;
    }

    public Vector2 PlayerMove
    {
        get => InputActions.Player.Move.ReadValue<Vector2>(); // 获取玩家移动输入向量
    }
