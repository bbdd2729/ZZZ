...
namespace SingularityGroup.HotReload.Editor {
    ...
    internal static class EditorCodePatcher {
        ...
        #if ODIN_INSPECTOR
        internal static bool DrawPrefix(InspectorProperty __instance) {
        ...
        internal static MethodInfo OdinPropertyDrawInfo = typeof(InspectorProperty)?.GetMethod("Draw", 0, BindingFlags.Instance | BindingFlags.Public, null, new Type[]{}, null);
        #else
        ...
        #endif
        internal static MethodInfo DrawOdinInspectorInfo = typeof(OdinEditor)?.GetMethod("DrawOdinInspector", BindingFlags.NonPublic | BindingFlags.Instance);
        #else
...
#pragma warning restore CS0612 // Type or member is obsolete
        ...
        static void OnIntervalMainThread() {
            ...
            if(ServerHealthCheck.I.IsServerHealthy) {
                ...
                RequestServerInfo();
                TryPrepareBuildInfo();
                if (!requestingCompile && (!config.patchEditModeOnlyOnEditorFocus || Application.isPlaying || InternalEditorUtility.isApplicationActive)) {
        ...
        internal static void CheckInlinedMethods() {
            ...
            try {
                ...
                if (newInlinedMethods?.Count > 0) {
                    ...
                    if (HotReloadPrefs.AutoRecompileUnsupportedChangesImmediately || InternalEditorUtility.isApplicationActive) {
                        TryRecompileUnsupportedChanges();
                    }
    ...
    internal static class UnityFieldDrawerPatchHelper {
        ...
        internal static bool GetHightPrefix(
            SerializedProperty property, GUIContent label, bool includeChildren,
            ref float __result
        ) {
            if (property == null || property.serializedObject == null || !property.serializedObject.targetObject) {
                // do nothing
